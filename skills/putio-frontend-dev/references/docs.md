...
9. Verify every claimed command, path, email address, doc link, badge target, and GitHub template path. If anything is broken, fix the doc and re-verify before stopping.
